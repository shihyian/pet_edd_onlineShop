                ...
                <form name="adminLogin" method="post" action="">
                    <table class="table_style text_height">
                        <tr>
                            ...
                            <td class="table_c4"><input type="text" name="adminAccount" size="25"></td>
                        </tr>
                        <tr>
                            <td class="ct table_c1">密碼：</td>
                            <td class="table_c4"><input type="text" name="adminPassword" size="25"></td>
                        </tr>
                    </table>
              		...
              		<div class="ct">
              			<?php 
                            ...
                            echo "<input type='submit' value='登入' name='login'>";
                            if(isset($_POST["login"])){
                                $account = $_POST["adminAccount"];
                                $password = $_POST["adminPassword"];
                                
                                while ($pass = mysqli_fetch_array($result,MYSQLI_ASSOC)) {
                                    if($account==$pass['admin_account'] && $password==$pass['admin_password']){
