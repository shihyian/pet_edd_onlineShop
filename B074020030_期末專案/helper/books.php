...
<?php
  ...
  $sql = "SELECT * FROM `product_in_detail` WHERE big_category = '培養小幫手' and small_category ='書籍'";
		...
		<div id="container">
			...
			<div id="sidebar_left" class="ct">
					...
					<div class="block_c">
						...
						<div class="ww"><a href="helper.php">培養小幫手</a>
							<div class="s">
								<a href="books.php">書籍</a>
								<a href="other_helper.php">其他</a>
							</div>
						</div>
