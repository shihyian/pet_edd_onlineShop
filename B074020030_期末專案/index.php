	...
	<div id="font">
        ...
        <div id="container">
            <div id="myHeader">寵物蛋蛋育成</div>            
             ...
             <!-- 上方功能列  -->
            <div id="top">
                <span class="change_color"><!--滑鼠滑過字會變色-->
            ...
            <div id="sidebar_right">
          		<form name="p_alter" enctype="multipart/form-data" action="">
          		<?php
          		    echo "<h3>全部商品</h3>";
                    ...
                    while($product=mysqli_fetch_array($result,MYSQLI_ASSOC)){
                        ...
                        echo '<a href="../detail.php?pass='.$product["name"].'">'."<img src='data:image/png;base64 ,".base64_encode($product["picture"])."'class='table_pic''></a>";
                        echo "</td>";
                        echo "<td class='table_c2'>".$product["name"]."</td>";
                        echo "</tr>";
                        echo "<tr>";
                        echo '<td class="table_c3">價格：'.$product["price"].'<a href="../detail.php?pass='.$product["name"].'"><img src="../picture/buy_icon.png" id="buy_icon1">';
                        echo "</td>";
                        echo "</tr>";
                        echo "<tr>";
