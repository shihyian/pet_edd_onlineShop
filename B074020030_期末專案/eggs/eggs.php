...
<?php
    ...
    $sql = "SELECT * FROM `product_in_detail` WHERE big_category = '各種蛋'";
        	...
        	<div id="sidebar_right">
                <?php
                    ...
                    while($product=mysqli_fetch_array($result,MYSQLI_ASSOC)){
                        ...
                        echo "</tr>";
                        echo "<tr>";
                        echo '<td class="table_c3">價格：'.$product["price"].'<a href="../tool_bar/member.html"><img src="../picture/buy_icon.png" id="buy_icon1">';
                        echo "</td>";
                        echo "</tr>";
                        echo "<tr>";
