...
<?php
  ...
  $sql = "SELECT * FROM `product_in_detail` WHERE big_category = '培養用具' and small_category = '孵蛋環境'";
		...
		<div id="container">
			...
			<div id="sidebar_left" class="ct">
					...
					<div class="block_c">
						...
						<div class="ww"><a href="pet_tools.php">培養用具</a>
							<div class="s">
								<a href="environment.php">孵蛋環境</a>
								<a href="other_tools.php">其他</a>
							</div>
						</div>
